...
- `KB-0` sculpt_kb DESIGN v2 + **`docs/sculpt_kb/EXAM_SAMPLE.md`** (worked
  item #0 = this overlay; Chris's findings = first fault-lexicon key) ·
  **awaiting_user_signoff** — R4/R5 in the sample also await his confirm/deny.
