...
**44 iterations. Not one credible London plane, by any method.** Not the grower, not mtree, not any hybrid.
Every entry that reads as progress was progress against an *instrument* — a scalar (DBH 1.04× census), a
wire (grower→skinner→render), a wood partition — and none of them ever constrained the deliverable: a tree
that looks like a London plane. **We never once looked at a finished, foliated tree.** iter-44's ★★★
REJECTED verdict summarizes the whole arc, not one iteration.

Chris also sat through ~40 turns of "continue" without understanding what was being done. That is a failure
of the work and of its legibility. Both are mine.

## Rails that survive the suspension — binding, not re-litigable

- ⛔ **NO MTREE.** It does not make species-specific trees, or we could not make it do so. Closed.
- ⛔ **NO SPEEDTREE**, or any third-party tree product. The project's premise is **Claude's own
  interpretation of the available data**. A bought tree is not the deliverable, however good it looks.
  This is a *definition of the project*, not a tooling preference.
- ⛔ **NO FINE-TWIG GEOMETRY** (perf, iter-44). Crown density comes from CARDS.
- ⛔ **DO NOT JUDGE HABIT FROM A LEAFLESS SCAFFOLD RENDER** (iter-44) — this representation keeps its crown
