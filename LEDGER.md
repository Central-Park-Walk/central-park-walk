...
double-background/orphan traps → feedback_token_discipline.md. ARCHIVED-only (already covered):
iter-34 dead-switch, iter-37 constraint-not-process (its proposal was refuted), iter-38 decompose.)*
