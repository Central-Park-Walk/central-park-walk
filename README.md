...
| Landmarks | 8 models | Bethesda Terrace (sandstone arcade + grand staircases + balustrades), Belvedere Castle (octagonal tower + loggia wing + battlements), Swedish Cottage (Scandinavian log cabin + steep gable), The Dairy (Victorian Gothic polychrome + loggia), Chess & Checkers House (octagonal timber pavilion), Loeb Boathouse (copper roof + lakeside deck), Delacorte Theater (semicircular amphitheater + backstage), 30 comfort stations |
