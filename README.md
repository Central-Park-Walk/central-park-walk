...
| Furniture | 1,022+ | Custom Blender models: Henry Bacon Type B lampposts (201), World's Fair benches (610, path-oriented), Landor aluminum trash cans (166), fountains (19), flagpoles (18), Rosenwach water towers (45) — cast iron/wood/aluminum shaders with weather response |
| Statues | 106 positions | 3 photogrammetry scans (+ Bethesda Fountain), Cleopatra's Needle obelisk (Blender model), labels mark unscanned locations |
