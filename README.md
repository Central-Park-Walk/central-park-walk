...
### Vegetation
Undergrowth, grass, and ground cover systems are zone-driven with per-species scale ranges from conservancy botanical data. Custom Blender-generated models (MIT/CC0). Terrain3D GPU particle grass with 4 biome layers. Seasonal wildflowers (crocus, daffodil, aster, goldenrod, violet, buttercup, dandelion, clover) generated by custom Blender scripts.
