...
GRID_W      = 2048         # heightmap output resolution (2.44 m/cell = the DEM's
GRID_H      = 2048         # NATIVE resolution; 8192/4096 were interpolated upscales
                           # with no real detail). MUST match Terrain3D: scene
                           # vertex_spacing=2.4426 + import_terrain3d → 4 regions.
ATLAS_RES   = 8192         # world atlas (CPU surface/occupancy) + landuse grid. NOTE:
                           # landuse_map.png is post-downsampled to 2048² (GPU texture);
                           # world_atlas.bin stays 8192 (CPU only).
