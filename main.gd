...
func _setup_environment() -> void:
	...
	_env.glow_bloom            = 0.15     # wide soft spread — impressionist light wrap
	_env.glow_blend_mode       = Environment.GLOW_BLEND_MODE_SOFTLIGHT
	_env.glow_hdr_threshold    = 0.8      # catch midtones, not just bright spots
	_env.glow_hdr_scale        = 0.6      # gentle contribution from mid-luminance
	_env.glow_hdr_luminance_cap = 8.0     # cap prevents firefly spikes
