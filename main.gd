...
func _setup_environment() -> void:
	...
	_env.glow_bloom            = 0.20     # wide luminous spread — EGTTR impressionist wrap
	_env.glow_blend_mode       = Environment.GLOW_BLEND_MODE_SOFTLIGHT
	_env.glow_hdr_threshold    = 0.65     # catch everything above mid-gray
	_env.glow_hdr_scale        = 0.5      # gentle contribution
	_env.glow_hdr_luminance_cap = 6.0     # cap prevents firefly spikes
