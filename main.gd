...
func _setup_environment() -> void:
	...
	_env.glow_bloom            = 0.12     # soft spread — impressionist without milky wash
	_env.glow_blend_mode       = Environment.GLOW_BLEND_MODE_SOFTLIGHT
	_env.glow_hdr_threshold    = 1.0      # above mid-luminance only
	_env.glow_hdr_scale        = 0.5
	_env.glow_hdr_luminance_cap = 6.0
