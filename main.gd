...
const GRASS_BIOMES := [
	{  # Maintained lawn — baked texture cards from BD3D Lawn mowed
		...
		"spacing": 0.12, "cell_width": 16.0, "grid_width": 9,
		"min_scale": Vector3(0.9, 0.7, 0.9),
	...
	{  # Wild meadow — baked texture cards from BD3D Wild Clump
		...
		"max_scale": Vector3(1.2, 1.1, 1.2),
		"position_offset": Vector3(0, -0.012, 0),
	},
	{  # Woodland floor — baked texture cards from BD3D Duo
		...
		"spacing": 0.25, "cell_width": 16.0, "grid_width": 9,
		"min_scale": Vector3(0.7, 0.5, 0.7),
		"max_scale": Vector3(1.2, 0.9, 1.2),
		"position_offset": Vector3(0, -0.008, 0),
	},
]
