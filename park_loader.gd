...
var _landmark_builder                   # landmark_builder.gd instance
var _detail_builder                     # detail_builder.gd instance
...
func _ready() -> void:
	...
	_landmark_builder._build_bethesda_terrace()
	_landmark_builder._build_belvedere_castle()
	_landmark_builder._build_comfort_stations(amenities)
	_landmark_builder._build_vanderbilt_gate()
	_landmark_builder._build_bandshell()
	_landmark_builder._build_pergola()
	_landmark_builder._build_ladies_pavilion()
	_landmark_builder._build_cherry_hill_fountain()
	_landmark_builder._build_summerhouse()
	_landmark_builder._build_model_boathouse()
	_landmark_builder._build_boat_landings()
	_landmark_builder._build_cop_cot()
	_landmark_builder._build_imagine_mosaic()
	...
	_landmark_builder._build_conservatory_fountains()
	_landmark_builder._build_rustic_bridges()
	_detail_builder._build_dog_run_fences(landuse_zones)
	_detail_builder._build_park_signs(paths)
	_detail_builder._build_reservoir_fence(water)
	_detail_builder._build_bridle_posts(paths)
	_detail_builder._build_playground_equipment(landuse_zones)
	_detail_builder._build_sports_equipment(landuse_zones)
	_detail_builder._build_fitness_stations(paths)
	...
	_detail_builder._build_drain_grates(paths)
	_detail_builder._build_bike_racks()
	_detail_builder._build_tree_pit_grates(trees)
	_detail_builder._build_curb_ramps(paths)
	_detail_builder._build_stone_urns()
	...
	#_detail_builder._build_staircases(paths)
...
func _collect_named_meshes(node: Node, out: Dictionary) -> void:
	if node is MeshInstance3D and node.mesh != null:
		...
		# Preserve surface override materials from the MeshInstance3D node.
		# GLB import often puts materials on the node, not the mesh resource.
