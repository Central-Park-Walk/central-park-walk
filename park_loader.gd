...
func _ready() -> void:
	...
	_infrastructure_builder._build_sports_equipment(landuse_zones)
	_infrastructure_builder._build_fitness_stations(paths)
	_infrastructure_builder._build_mile_markers(paths)
	...
	_infrastructure_builder._build_call_boxes(paths)
	_infrastructure_builder._build_info_kiosks()
	_infrastructure_builder._build_drain_grates(paths)
	_infrastructure_builder._build_bike_racks()
	_infrastructure_builder._build_tree_pit_grates(trees)
	_infrastructure_builder._build_curb_ramps(paths)
	_infrastructure_builder._build_stone_urns()
